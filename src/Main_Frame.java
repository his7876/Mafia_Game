...
public class Main_Frame extends JFrame{
    ...
    private void setDisplay(JPanel pnl) {
    	...
    	Room_Create_Button = new JButton("规 涝厘");
    	dialog = new roomDialog(this, "规 积己", true);
...
//    	room_model.addElement("规 1");
//    	room_model.addElement("规 2");
//    	room_model.addElement("规 3");
//    	room_model.addElement("规 4");

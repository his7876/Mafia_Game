...
public class MafiaTestClient {
	private CMClientStub m_clientStub;
	private MafiaClientEventHandler m_eventHandler;
	private boolean m_bRun;
	private Scanner m_scan = null;
	
	public MafiaTestClient()
	{
		m_clientStub = new CMClientStub();
		m_eventHandler = new MafiaClientEventHandler(m_clientStub);
		m_bRun = true;
	}
	...
	public MafiaClientEventHandler getClientEventHandler()
	{
	...
	public void startTest()
	{
		...
		while(m_bRun)
		{
			...
			try {
				...
				info = new UserGameEventInfo();
				info.args = strInput;
				info.roomID = -1;
				info.userName = myself.getName();
				info.opcode = 3;
			...
			case 0:
				...
				break;
			case 1:
				System.out.println("서버 방 들어가기 시도\n");
				info = new UserGameEventInfo();
				info.args = "[]";
				info.roomID = -1;
				info.userName = myself.getName();
	...
	public void testStartCM()
	{
		...
		strNewServerAddress = strCurServerAddress;
		System.out.print("new server port (enter for current value): ");
		strNewServerPort = nCurServerPort + "";
...
//		m_clientStub.requestAttachedFileOfSNSContent(nContentID, strWriterName, strFileName);
	...
	public static void main(String[] args) {
		...
		MafiaTestClient client = new MafiaTestClient();
